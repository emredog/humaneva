function [xform] = xRotation(phi, hand)
% Generates 3-D rotation matrix for the x-axis rotation
% 
% Format: 
%   [XFORM] = xRotation(PHI, HAND)
%
% Input:
...
xform = [1   0              0              0
         0   cos(phi)       hand*sin(phi)  0
         0  -hand*sin(phi)  cos(phi)       0 
         0   0              0              1];