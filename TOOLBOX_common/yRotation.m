function [xform] = yRotation(theta, hand)
% Generates 3-D rotation matrix for the y-axis rotation
% 
% Format: 
%   [XFORM] = yRotation(THETA, HAND)
%
% Input:
...
xform = [cos(theta)       0  -hand*sin(theta)  0
         0                1   0                0
         hand*sin(theta)  0   cos(theta)       0
         0                0   0                1];
